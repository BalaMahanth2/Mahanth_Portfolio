...
function Row({ Icon, label, value, href }) {
  ...
  return (
    ...
    >
      <div className="w-11 h-11 rounded-lg grid place-items-center bg-gradient-to-br from-cyan-500/20 to-indigo-500/20 border border-cyan-400/30 text-cyan-300 group-hover:shadow-[0_0_24px_rgba(56,189,248,0.35)] transition">
  ...
  return (
    <label className="block">
      ...
      <Tag
        ...
        className="w-full bg-white/[0.03] border border-white/10 rounded-lg px-4 py-2.5 text-sm text-white placeholder:text-white/25 focus:outline-none focus:border-cyan-400/60 focus:shadow-[0_0_0_3px_rgba(56,189,248,0.12)] transition"
      />
    </label>
  );
}
